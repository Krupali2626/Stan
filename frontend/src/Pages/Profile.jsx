...
const StyleDiv = ({ children }) => {
    return (
        <div
            className="relative group bg-gradient-to-br from-[#2e241a]/80 to-[#3d3215]/80 backdrop-blur-xl rounded-2xl p-3  border border-orange-500/30 shadow-lg hover:shadow-orange-500/40 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] overflow-hidden ds_height_manage"
        >
